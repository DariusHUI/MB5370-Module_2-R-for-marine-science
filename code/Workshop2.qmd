...
This code contains the work realised for the second workshop of the second module of MB5370.

This workshop focus on the improvement of foundations of data wrangling with the principles of "tidy data" and mastering tidyverse.

In order to accomplish this goal, this code structure follows these topics:

  1. Tidying data
  2. Pivoting data to make it tidy
    2.1 Lengthening datasets
    2.2 Widening datasets
    2.3 Pivoting Exercise using Palmer Penguins
      
      2.3.1 Lengthening data wint pivot_longer()
      
      2.3.2 Widening data with pivot_wider()
  3. Separating and uniting data tables
  4. Wrangling strings and dates
  5. Relational data: Joining tables
  
      5.1 Relational data: Joint tables
  
      5.2 The workhorse: left_join()
  
      5.3 The strict filter: inner_join()
  
      5.4 The detective: anti_join()
  6. Handling missing values
  
      6.1 Converting legacy errors with na_if()
  
      6.2 Replacing missing values with coalesce()
  
      6.3 The special case of NaN (Not a Number)
  
      6.4 Implicit missing calues and the zero-data framework: complete()
  
      6.5 The nuclear option: drop_na()
  7. Practical exercises: Penguins, pivots, and relational data

Note: An additional exercise (exercise 12) of this workshop has been realised as well. It is in the Workshop2_Ex12.qmd file.
...
## 2.3 Pivoting Exercise using Palmer Penguins
### 2.3.1 Lengthening data with pivot_longer()
...
# 5. Relational data: Joining tables
## 5.1 Relational data: Joining tables
...
## 6.4 Implicit missing values and the zero-data framework: complete()
